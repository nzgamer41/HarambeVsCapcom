...
type=changestate
value=40
triggerall = Var(20) = 20 && p2life!= 0 && Random < 550 && Life != 0 && stateno != [800,899] 
triggerall = StateType = S
...
[State -1]
type = ChangeState
value = ifelse(Frontedgebodydist<=90,105,ifelse(random>=750,1102,66))
triggerall = Var(20) = 20 && ctrl
triggerall = StateType != A && StateType != L
triggerall = Life != 0 && P2Life != 0 &&  MoveType != H 
triggerall = stateno != [66,67]
triggerall = enemy,stateno!=459
trigger1 = P2BodyDist X = [10,45]
trigger1 = enemy, statetype != A
trigger1 = Random <= 500	
trigger1 = enemy, movetype = I	
trigger2 = P2BodyDist X = [30,75]
trigger2 = enemy, statetype = A
trigger2 = Random <= 500	
trigger2 = enemy, movetype = I
;====================================
;AI Light Punch
[State -1]
type = ChangeState
...
triggerall = Var(20) = 20 && Life != 0&& power>=2000
triggerall = statetype != A
triggerall = ctrl && p2life!= 0
...
trigger2 = p2stateno = 50
;===================================
;AI Air Shadow Slice/Boom
[State -1]
type=changestate
value=ifelse(random >=500,1202,1010)
trigger1= Var(20) = 20 && Life != 0
trigger1= roundstate=2 && statetype=A
trigger1= ctrl && p2life!= 0
trigger1= Var(31)=0
trigger1= pos y <= -100
trigger1= (p2bodydist x=[50,120]) && (p2dist y=[0,150])
;===================================
;AI Shadow Slice Ground
[State -1]
type=changestate
value = ifelse(power>=3000,3010,ifelse(power>=2000,3000,1252))
triggerall= Var(20) = 20 && p2life!= 0 && Life != 0 && ctrl 
triggerall= roundstate=2 && statetype!=A
triggerall= (enemynear,vel x=[-1,1])
;triggerall= enemy,HitDefAttr=SC,NP,SP
triggerall= (enemy,statetype=S||enemy,statetype=C) && (enemy,animtime<=-30)
trigger1 = P2BodyDist X = [150,250]
trigger1 = enemy, Numproj >= 1&&enemy,stateno<2999
trigger2 = P2BodyDist X = [150,250]
trigger2 = enemy, Numhelper >= 1&&enemy,stateno<2999
;===================================
;AI Shadow Boom
[State -1]
type = ChangeState
value = ifelse(power>=3000,3010,ifelse(power>=2000,3000,1000))
triggerall = Var(20) = 20 && p2life!= 0 && Random > 450 && Life != 0 && stateno != [800,899] 
triggerall = Life != 0
triggerall = ctrl && p2life!= 0
triggerall = StateType!=A && MoveType != H
triggerall = enemy,stateno!=259
triggerall = numhelper<=0
trigger1 = P2bodydist X >=150
trigger1 = p2stateno = [5050,5110]
trigger1 = p2movetype != A
trigger2 = Stateno = 5210 && time>=18
trigger3 = (P2BodyDist Y >= -150) && (P2MoveType != H)
trigger3 = P2bodydist X >=150
;====================================
;AI Roll Back
[State -1]
type = ChangeState
value = ifelse(Backedgebodydist<=90,66,ifelse(random>=750,40,67))
triggerall = Var(20) = 20 && ctrl
triggerall = StateType != A && StateType != L
triggerall = Life != 0 && P2Life != 0 &&  MoveType != H 
triggerall = stateno != [66,67]
...
trigger1 = Enemy,stateno=[5200,5210]
trigger2 = Enemy,stateno=5120
;===================================
;AI Lie Down Roll Foward
[State -1,Lie Down Roll Foward Hard AI]
type = ChangeState
value = 940
triggerall = Var(20) = 20 && time % 4
triggerall = p2bodydist X >= 0
triggerall = Life != 0 && MoveType != H
...
trigger2 = random <= 998
trigger3 = (enemy,vel X != [-3,3]) && (P2BodyDist Y >= -100)
;====================================
;AI Lie Down Roll Back
[State -1,Lie Down Roll Back Hard AI]
type = ChangeState
value = 941
triggerall = Var(20) = 20  && time % 4 
triggerall = Life != 0 && MoveType != H
...
trigger3 = (enemy,vel X != [-3,3]) && (P2BodyDist Y >= -100)
;====================================
;AI Recovery Roll Foward
[State -1,Recovery Roll Forward Hard AI]
type =ChangeState
value =942
triggerall = Var(20) = 20  && time % 4 
...
trigger2 = random <= 998	
trigger3 = (enemy,vel X != [-3,3]) && (P2BodyDist Y >= -100)
trigger4 = P2movetype != A&& Random<=300
;====================================
;AI Recovery Roll Back
[State -1,Recovery Roll Back Hard AI]
type =ChangeState
value =943
triggerall = Var(20) = 20  && time % 4 
triggerall = Life != 0 && pos y >= 0
...
type = ChangeState
value = 700
triggerall = Var(20) = 20 && random > life && time % 4 
triggerall = StateType != A && StateType != L
triggerall = P2StateType != C
triggerall = P2life != 0
triggerall = stateno!=[5130,5138]
...
type = ChangeState
value = 705
triggerall = Var(20) = 20 && random > life && time % 4 && ctrl
...
type = ChangeState
value = 710
triggerall = Var(20) = 20 && time % 4 && ctrl
triggerall = StateType = A && StateType != L
triggerall = P2life != 0
